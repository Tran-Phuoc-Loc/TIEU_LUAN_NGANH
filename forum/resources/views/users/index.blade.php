...
<div class="modal" id="commentModal" style="display:none;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @if(auth()->check())
            <form id="commentForm" action="{{ route('comments.store', $post->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <textarea name="content" class="form-control mt-2" rows="3" placeholder="Nhập bình luận của bạn" required></textarea>
